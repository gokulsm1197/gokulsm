      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div onClick={() => window.open(source_code_link, "_blank")}
            className="w-12 h-12 rounded-full flex justify-center items-center cursor-pointer bg-blue-100 hover:bg-blue-200 shadow-md transition">
               <img
                 src={github}
                  alt="source code"
           ...
           {/*  <div
            ...
            >
              <img src={github} alt="source code" className="w-1/2 h-1/2 object-contain c" />
            </div> */}
          </div>
        </div>
        <div className="mt-5">
